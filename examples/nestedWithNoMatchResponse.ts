import FlyingRouter, { Options } from "../src";
...
let options: Options<IncomingMessage, ServerResponse> = {
  noMatchResponse: (req: Request<IncomingMessage>, res: ServerResponse): void => {
    res.statusCode = 404;
...
let r1: Router<IncomingMessage, ServerResponse> = new Router();
let r2: Router<IncomingMessage, ServerResponse> = new Router();
...
r2.get("/:param", (req: Request<IncomingMessage>, res: ServerResponse) => {
  let str = "Params:\n";
